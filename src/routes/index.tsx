      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-20 sm:px-6">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-2 text-3xl font-extrabold tracking-tight sm:text-4xl">
            Why exhibit at {eventConfig.name}?
          </h2>
          <p className="mt-3 text-base text-muted-foreground">
            Position your brand directly in front of thousands of international buyers, key
            procurement managers, and industry leaders.
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                Hover over any space to inspect dimensions, pricing, and category. Click to start
      ...
      <section className="border-t border-border bg-ink text-ink-foreground py-16">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 text-center">
          ...
          <p className="mt-3 max-w-2xl mx-auto text-sm opacity-80">
            Exhibition spaces are limited and assigned on a first-come, first-served basis. Reserve
            your preferred location today.
          </p>
